...
/**
 * @title ltTokenStorage
 * @author Venus
 * @notice Storage layout used by the `LtToken.sol` contract
 */
// solhint-disable-next-line max-states-count
contract LtTokenStorage {
    /**
    ...
    /**
     * @notice Underlying asset for this LtToken.sol
     */
    ...
    /**
     * @notice Contract which oversees inter-ltToken operations
     */
    ...
    // Initial exchange rate used when minting the first ltTokens (used when totalSupply = 0)
...
/**
 * @title LtTokenInterface
 * @author Venus
 * @notice Interface implemented by the `LtToken.sol` contract
 */
abstract contract LtTokenInterface is LtTokenStorage {
    ...
    event LiquidateBorrow(
        ...
        address indexed borrower,
        uint256 repayAmount,
        address indexed ltTokenCollateral,
        uint256 seizeTokens
    );
    ...
    /**
     * @notice Indicator that this is a LtToken.sol contract (for inspection)
     * @return Always true
     */
    function isLtToken() external pure virtual returns (bool) {
        return true;
    }
}
