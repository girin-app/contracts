...
IProtocolShareReserve
{
    ...
    /// @notice address of WXRP contract
    /// @custom:oz-upgrades-unsafe-allow state-variable-immutable
    address public immutable WXRP;

    /// @notice address of vXRP contract
    /// @custom:oz-upgrades-unsafe-allow state-variable-immutable
    address public immutable vXRP;
     ...
     * @param _wxrp The address of WXRP
     * @param _vxrp The address of vXRP
     */
    ...
    constructor(
        ...
        ensureNonzeroAddress(_wxrp);
        ensureNonzeroAddress(_vxrp);
    ...
    function updateAssetsState(
        ...
        if (
            ...
            PoolRegistryInterface(poolRegistry).getLtTokenForAsset(comptroller, asset) == address(0)
