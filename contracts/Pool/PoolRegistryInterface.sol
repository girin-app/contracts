...
interface PoolRegistryInterface {
    ...
    /// @notice Get the address of the LtToken.sol contract in the Pool where the underlying token is the provided asset
    function getLtTokenForAsset(address comptroller, address asset) external view returns (address);
